...
: ${AMENT_CURRENT_PREFIX:="/sick_visionary_ros2/sick_visionary_ros2/install/sick_visionary_ros2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sick_visionary_ros2/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sick_visionary_ros2/environment/path.sh"
